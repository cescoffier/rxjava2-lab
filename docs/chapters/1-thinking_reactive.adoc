...
This is your first RX Java application. A couple of points to note:
...
A gentle note about `subscribe`... If you don't subscribe to a stream, nothing happens. None of the processing stage will be executed until you subscribe to it. This is very important to remember to avoid thousands of hours of debugging!
