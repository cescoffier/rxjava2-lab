...
There are different predefined schedulers by RxJava
...
In addition if you Vert.x, it provides also schedulers as well to execute operations within Vert.x thread pools.
