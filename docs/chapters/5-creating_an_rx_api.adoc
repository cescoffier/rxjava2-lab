...
As you can see it's just a matter of building the right pipeline to get the file contents and transform it to the result we are looking for. For instance, `me.escoffier.lab.chapter5.Code2` creates a `JsonArray` from the contents of the file:
